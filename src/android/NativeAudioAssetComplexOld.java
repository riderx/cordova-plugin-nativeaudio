//
//
//  NativeAudioAssetComplexOld.java
//
...
public class NativeAudioAssetComplexOld implements OnPreparedListener, OnCompletionListener {
	...
	public NativeAudioAssetComplexOld( AssetFileDescriptor afd, float volume)  throws IOException
	{
		state = INVALID;
		mp = new MediaPlayer();
